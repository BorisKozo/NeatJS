...
export class Player {
  ...
  crossover(parent) {
    ...
    if (parent.fitness < this.fitness) child.brain = this.brain.crossover(parent.brain);
  ...
  move() {
    let maxIndex = 0;
    for (let i = 0; i < this.decisions.length; i++) if (this.decisions[i] > this.decisions[maxIndex]) maxIndex = i;
